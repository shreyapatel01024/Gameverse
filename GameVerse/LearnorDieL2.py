...
fontrunbutton = pygame.font.Font(None, 36)
fontheadinginterpreter = pygame.font.Font(None, 36)
...
def draw_game(cursor_visible, hover=False, click=False):
    ...
    label_text =fontheadinginterpreter.render("Write Code Here", True, BLACK)
    ...
    button_text = fontrunbutton.render("Run", True, GRAY)
    ...
    for i, line in enumerate(question_text):
        ...
        screen.blit(text_surface, (20, 20 + i * 20))  # Position each line with a gap
    for i, line in enumerate(question_text2):
        text_surface = font.render(line, True, BLACK)
        screen.blit(text_surface, (300, 25 + i * 22))  # Position each line with a gap
    # Display attempts left
    attempts_left = font.render(f"Attempts left: {3 - wrong_attempts}", True, BLACK)
    screen.blit(attempts_left, (20, 80))
...
def level_completed():
    ...
    if fetched_level and fetched_level[0]== 2:
    ...
    level_completed_text = fontlevelcompleted.render(f"Level 2 Completed!", True, DARK_BLUE)
